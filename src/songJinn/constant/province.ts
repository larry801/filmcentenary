...
const idToProvince = {
    ...
    [ProvinceID.XIJINGLU]:{id:ProvinceID.XIJINGLU,name:"西京路",capital:[CityID.DaTong],adjacent:[ProvinceID.BEIJINGLU,ProvinceID.DONGJINGLU,ProvinceID.HEDONGLU],other:[],regions:[RegionID.R01,RegionID.DaTonFu02,RegionID.WuShuo2Zhou03,RegionID.R04]},
